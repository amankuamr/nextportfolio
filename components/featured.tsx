                                ...
                                >
                                    <Card className="h-full overflow-hidden bg-white border border-gray-200 shadow-none rounded-2xl">
                                        ...
                                        <CardFooter className="pt-0 flex gap-2">
                                            ...
                                            {item.githubUrl && (
                                                        <Button asChild variant="outline" size="sm" className="card-outline flex-1 border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors duration-200 rounded-full">
